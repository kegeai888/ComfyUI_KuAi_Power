...
NODE_CLASS_MAPPINGS = {**VEO3_MAPPINGS, **BATCH_MAPPINGS, **CONCURRENT_MAPPINGS, **CSV_CONCURRENT_MAPPINGS, **BATCH_IMAGE_MAPPINGS, **DIR_BATCH_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**VEO3_DISPLAY_MAPPINGS, **BATCH_DISPLAY_MAPPINGS, **CONCURRENT_DISPLAY_MAPPINGS, **CSV_CONCURRENT_DISPLAY_MAPPINGS, **BATCH_IMAGE_DISPLAY_MAPPINGS, **DIR_BATCH_DISPLAY_MAPPINGS}
