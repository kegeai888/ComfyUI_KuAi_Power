...
- **参考图支持**: 最多支持 6 张参考图像
- **搜索增强**: 启用 `use_search` 可利用网络搜索提升生成质量
- **Grounding**: 自动提取引用来源和思考过程
- **灵活配置**: 支持自定义 API 端点和密钥

**实现位置**: `nodes/NanoBanana/nano_banana.py:18-217`
...
**实现位置**: `nodes/NanoBanana/nano_banana.py:220-445`
